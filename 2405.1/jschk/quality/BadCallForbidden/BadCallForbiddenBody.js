var initVae = 1;
var var2 = forbidden(0); // @violation
var obj = new Clazz();
var vareeee4 = forbidden(1); // @violation
function sub(){

 with(document.f){
 a.value='aaa';
 b.value='bbb';
 c.value = forbidden(1,2,3,4); // @violation
 }
...
var html5sql = (function () {
	...
	var readTransactionAvailable = false,
	    ...
	    isSelectStmt = function (sqlstring) {
			return SelectStmtMatch.forbidden(sqlstring); // @violation
		},
		doNothing = function(){},
