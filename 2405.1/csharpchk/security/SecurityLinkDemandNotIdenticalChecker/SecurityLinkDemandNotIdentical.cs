...
namespace SecurityRulesLibrary
{
   ...
   public class OverridesAndSecurity : ITestOverrides
   {
      ...
      object ITestOverrides.GetFormat(Type formatType) // @violation
      {
