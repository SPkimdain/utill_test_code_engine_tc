...
namespace SecurityRulesLibrary
{
    ...
    public class SerializationConstructorsRequireSecurity : ISerializable
    {
        ...
        protected SerializationConstructorsRequireSecurity (SerializationInfo info, StreamingContext context) // @violation
        {
    ...
    [Serializable]
    public class SerializationConstructorsRequireSecuritySafe : ISerializable
    {
        private  int n1;
        // This is a regular constructor secured by a demand.
        [FileIOPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
